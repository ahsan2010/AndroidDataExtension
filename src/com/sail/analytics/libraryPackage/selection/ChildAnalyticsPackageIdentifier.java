package com.sail.analytics.libraryPackage.selection;
...
public class ChildAnalyticsPackageIdentifier implements Runnable{

	public  String JAR_DIRECTORY = "/safwatscratch/shassan/Jars/";
	public String OUTPUT_LOCATION =  ProjectConstants.ROOT + "AnalyticsPackageNameExtraction/";
	public String ANALYTICS_LIBRARY_MAP = "/home/local/SAIL/ahsan/Documents/SAIL_Projects/Android_Data_Extension/Data/List_of_Analytics_Library.csv";
	ArrayList<String>updateLink = new ArrayList<String>();
	Map<String,String> varifiedAnalyticPackageGroup = FileUtil.readVerfiedAnalyticsLibraryList(ANALYTICS_LIBRARY_MAP);
	...
	public HashMap<String,Integer> analyticsLibraryDetection(String updateInfo){
		...
		try{
			...
			for (String key : javaClassesMap.keySet()) {
				...
				if(TextUtil.isAnalyticsLibrary(packageName, className) || varifiedAnalyticPackageGroup.containsKey(packageName)){
	...
	public void run() {
		...
		try{
			for(int i = startPosition ; i < endPosition ; i ++ ){				
				try{
					analyticsLibraryDetection(updateLink.get(i));
	...
	public ChildAnalyticsPackageIdentifier(){
		
	}
	public ChildAnalyticsPackageIdentifier(ArrayList<String> updateLink, int start, int end, int threadNo){
		this.updateLink = updateLink;
		this.startPosition = start;
		this.endPosition = end;
		this.THREAD_NO = threadNo;
		try{
			writer = new CsvWriter(OUTPUT_LOCATION +"AnalyticPackage_"+threadNo);
	...
	public static void main(String[] args) {
		ChildAnalyticsPackageIdentifier ob = new ChildAnalyticsPackageIdentifier();
